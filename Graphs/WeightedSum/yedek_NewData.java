...
public class yedek_NewData {
	...
	public static void main(String[] args) throws Exception  {		
       ...
       solve();
        ...
        System.out.println("AGREGATE EFF-CONCAVE");	
        ...
        for(int i=0;i<TypeOfCourse;i++){
				...
				for (int j=0;j<PossibleCourseLocations;j++){	
					...
					//DENEME!!!!!!
						...
						try {
							fileWriterr = new FileWriter("C:\\Users\\dakol\\Desktop\\Yedek_NewData_objective.txt", true);					
	                    ...
	                    FileWriter eff_graph = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AE_C.txt", true);
	                    eff_graph.write(String.valueOf(otherobject_effgraph2));
	                    eff_graph.write("\n");
	                    eff_graph.close();
	                    
	                    FileWriter eff = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AE_L.txt", true);
						eff.write(String.valueOf(total1));
						eff.write("\n");
	                    eff.close();
	                    
	                    FileWriter fair = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AF_C.txt", true);
	                    fair.write(String.valueOf(total2));
	                    fair.write("\n");
	                    fair.close();
	                    
	                    FileWriter u0 = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_CW1.txt", true);
						u0.write(String.valueOf(othervalue1));
						u0.write("\n");
	                    u0.close();
	                    
	                    FileWriter u1 = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_CW2.txt", true);
						u1.write(String.valueOf(othervalue2));
						u1.write("\n");
	                    u1.close();
	                    
	                    FileWriter fw = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_y_values.txt", true);	
			            for(int i=0;i<TypeOfCourse;i++){
	    					for (int j=0;j<PossibleCourseLocations;j++){	
			           	 ...
			           	 FileWriter deneme= new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_deneme.txt", true);	
		...
		deneme.write("\n");
							...
							try {
								fileWriter = new FileWriter("C:\\Users\\dakol\\Desktop\\Yedek_NewData_z_values.txt", true);
...
*/
            ...
            cplex.solve();
            cplex.exportModel("NewData_yedek2.lp");
			...
			for (int j=0;j<PossibleCourseLocations;j++){	
				if(cplex.getValue(y[1][j])>=0.9){
					...
					System.out.println(total12);
				 	 ...
				 	 FileWriter deneme;
						try {
							deneme = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_deneme.txt", true);
	 		...
	 		deneme.write("\n");
						...
						try {
							eff_graph = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AE_C.txt", true);
							   eff_graph.write(String.valueOf(otherobject_effgraph2));
			                    eff_graph.write("\n");
			                    eff_graph.close();
						} catch (IOException e) {
	                    ...
	                    FileWriter eff;
						try {
							eff = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AE_L.txt", true);
							eff.write(String.valueOf(total1));
							eff.write("\n");
	                    ...
	                    FileWriter fair;
						try {
							fair = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_AF_C.txt", true);
						     fair.write(String.valueOf(total2));
			                    fair.write("\n");
	                    ...
	                    FileWriter u0;
						try {
							u0 = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_CW1.txt", true);
							u0.write(String.valueOf(othervalue1));
							u0.write("\n");
		                    u0.close();
		                    } catch (IOException e) {
	                    ...
	                    FileWriter u1;
						try {
							u1 = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_CW2.txt", true);
							u1.write(String.valueOf(othervalue2));
							u1.write("\n");
		                    u1.close();
		                    } catch (IOException e) {
	                    ...
	                    FileWriter fw;
						try {
							fw = new FileWriter("C:\\Users\\dakol\\Desktop\\yedek_NewData_y_values.txt", true);
